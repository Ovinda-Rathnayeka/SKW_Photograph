...
import {
  fetchAllBookings,
  updateBookingStatus,
} from "../../API/UserAPI/BookingAPI.js";
...
function DisplayBooking() {
  ...
  if (loading)
    return (
      <div className="text-center py-6 text-slate-600">Loading bookings...</div>
    );
  if (error)
          ...
          <thead className="bg-slate-100 text-slate-700">
            <tr>
              {[
                ...
                <th
                  key={head}
                  className="px-4 py-3 border-b text-left whitespace-nowrap"
                >
                  {head}
                </th>
              ))}
            ...
            {bookings.map((booking) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-2">
                    {booking.packageId ? `$${booking.packageId.price}` : "N/A"}
                  </td>
                  <td className="px-4 py-2">
